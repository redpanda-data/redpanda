...
`LLVM_VERSION` is still required to install the bootstrap compiler from apt.llvm.org. `LLVM_REF` can be any git ref: a tag (`llvmorg-22.1.0`), branch (`main`), or commit SHA.
