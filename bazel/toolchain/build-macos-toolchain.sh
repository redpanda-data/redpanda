...
# cmake installs to ${prefix}/lib/, giving lib/x86_64-unknown-linux-gnu/lib/libc++.a.
# Move libraries up one level so clang finds them at lib/x86_64-unknown-linux-gnu/libc++.a.
mv "${INSTALL_PREFIX}/lib/x86_64-unknown-linux-gnu/lib/"*.a \
  "${INSTALL_PREFIX}/lib/x86_64-unknown-linux-gnu/"
...
# cmake installs to ${prefix}/lib/, giving lib/aarch64-unknown-linux-gnu/lib/libc++.a.
# Move libraries up one level so clang finds them at lib/aarch64-unknown-linux-gnu/libc++.a.
mv "${INSTALL_PREFIX}/lib/aarch64-unknown-linux-gnu/lib/"*.a \
  "${INSTALL_PREFIX}/lib/aarch64-unknown-linux-gnu/"
