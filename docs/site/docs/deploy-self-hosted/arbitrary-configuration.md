...
Cluster. However, Redpanda offers a broad range of parameters ([Custom configuration](/docs/features/configuration)) not all of which are included in the Cluster definition.
