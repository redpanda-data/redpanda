...
> **_Note_** - Shadow Indexing is available for Redpanda 21.11.3 and later.
...
(<code>cloud_storage_remote_write</code>) | Topic-level configuration 
(<code>redpanda.remote.write</code>) | Outcome 
