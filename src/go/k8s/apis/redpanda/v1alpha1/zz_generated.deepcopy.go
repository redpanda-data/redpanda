...
func (in *RestartConfig) DeepCopyInto(out *RestartConfig) {
	*out = *in
	...
	if in.DisableReadinessProbe != nil {
		in, out := &in.DisableReadinessProbe, &out.DisableReadinessProbe
		*out = new(bool)
		**out = **in
	}
	if in.DisableClusterHealthCheck != nil {
		in, out := &in.DisableClusterHealthCheck, &out.DisableClusterHealthCheck
		*out = new(bool)
		**out = **in
	}
