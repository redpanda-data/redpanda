...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecreRef) DeepCopyInto(out *SecreRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecreRef.
func (in *SecreRef) DeepCopy() *SecreRef {
	if in == nil {
		return nil
	}
	out := new(SecreRef)
