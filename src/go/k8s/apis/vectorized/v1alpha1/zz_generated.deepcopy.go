...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConsoleMigration) DeepCopyInto(out *ConsoleMigration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConsoleMigration.
func (in *ConsoleMigration) DeepCopy() *ConsoleMigration {
	if in == nil {
		return nil
	}
	out := new(ConsoleMigration)
	in.DeepCopyInto(out)
	return out
}
