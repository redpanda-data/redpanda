...
//+kubebuilder:rbac:groups=redpanda.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=redpanda.com,resources=topics/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=redpanda.com,resources=topics/finalizers,verbs=update
