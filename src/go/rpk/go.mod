...
require (
	...
	buf.build/gen/go/redpandadata/dataplane/connectrpc/go v1.16.0-20240322160234-5037c4cf27a2.1
	buf.build/gen/go/redpandadata/dataplane/protocolbuffers/go v1.33.0-20240322160234-5037c4cf27a2.1
	...
	github.com/hamba/avro/v2 v2.20.0 // if this version changes, update the fork in the replace directive below to match
...
require (
	...
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.33.0-20221127060915-a1ecdc58eccd.1 // indirect
...
replace github.com/hamba/avro/v2 => github.com/andrewhsu/avro/v2 v2.0.0-20240404213240-4de1b7f72f49 // keep the replacement fork in sync with the ver in the require directive entry above
