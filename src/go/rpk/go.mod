...
require (
	...
	buf.build/gen/go/redpandadata/core/protocolbuffers/go v1.36.9-20250917185005-f05ee4b4334a.1
...
require (
	...
	buf.build/gen/go/redpandadata/core/connectrpc/go v1.18.1-20250917185005-f05ee4b4334a.1 // indirect
