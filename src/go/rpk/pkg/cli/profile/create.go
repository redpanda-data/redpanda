...
func fromVirtualCluster(yAuth *config.RpkCloudAuth, rg *controlplanev1beta2.ResourceGroup, sc *controlplanev1.ServerlessCluster, usePrivate bool) CloudClusterOutputs {
