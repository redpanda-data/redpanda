		...
		Run: func(_ *cobra.Command, topicArg []string) {
			...
			for _, topic := range resp.Topics {
				...
				t := describedTopic{
					...
					Configs:    buildDescribeTopicConfig(prepDescribeTopicConfig(topic, cl)),
...
func prepDescribeTopicConfig(topic kmsg.MetadataResponseTopic, cl *kgo.Client) []kmsg.DescribeConfigsResponseResourceConfig {
