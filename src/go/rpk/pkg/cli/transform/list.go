...
`,
		...
		Run: func(cmd *cobra.Command, _ []string) {
			...
			if p.CheckFromCloud() && !p.CloudCluster.IsServerless() {
				...
				res, err := cl.Transform.ListTransforms(cmd.Context(), connect.NewRequest(&dataplanev1.ListTransformsRequest{}))
...
func dataplaneToAdminTransformMetadata(transforms []*dataplanev1.TransformMetadata) []rpadmin.TransformMetadata {
