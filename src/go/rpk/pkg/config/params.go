...
func getField(tags []string, parentRawTag string, v reflect.Value) (fieldVal reflect.Value, otherFieldVal reflect.Value, err error) {
...
func getFieldByTag(tag string, v reflect.Value) (fieldVal reflect.Value, otherFieldVal reflect.Value, err error) {
	var (
		t       = v.Type()
		other   bool
		inlines []int
