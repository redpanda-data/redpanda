...
struct client_opts {
  ...
  rp::wal_topic_type topic_type = rp::wal_topic_type::wal_topic_type_regular;

  /// \brief use this compression type on every record after the
  /// @record_compression_threshold
  rp::wal_compression_type record_compression_type =
    rp::wal_compression_type::wal_compression_type_lz4;
