...
namespace std {
inline ostream &
operator<<(ostream &o, ::rp::page_cache_result::priority p) {
  seastar::sstring it = "high";
  if (p == ::rp::page_cache_result::priority::low) { it = "low"; }
  return o << "rp::page_cache_result::priority{" << it << "}";
}
inline ostream &
operator<<(ostream &o, const ::rp::page_cache_result &r) {
  return o << "rp::page_cache_result{begin_pageno: " << r.begin_pageno
