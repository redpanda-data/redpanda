...
ostream &
operator<<(ostream &o, const rp::wal_put_partition_records &r) {
...
ostream &
operator<<(ostream &o, const rp::wal_binary_record &r) {
  o << "wal_binary_record={ data(size): " << r.data()->size() << "} ";
  return o;
}
ostream &
operator<<(ostream &o, const rp::wal_binary_recordT &r) {
