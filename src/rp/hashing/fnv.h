...
inline uint32_t
fnv32_buf(const void *buf, size_t n,
...
inline uint64_t
fnv64_buf(const void *buf, size_t n,
...
inline uint64_t
fnva64_buf(const void *buf, size_t n,
