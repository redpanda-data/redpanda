...
enum class s3_error_code {
    ...
    endpoint_not_found,
    device_not_active_error,
    conditional_request_conflict,
    connection_closed_by_requester,
    client_token_conflict,
    bucket_has_access_points_attached,
    invalid_access_point_alias_error,
    incorrect_endpoint,
    invalid_http_method,
    invalid_host_header,
    invalid_bucket_owner_aws_account_id,
    invalid_bucket_acl_with_object_ownership,
    ...
    no_such_async_request,
    no_such_cors_configuration,
    no_such_multi_region_access_point,
    no_such_object_lock_configuration,
    no_such_website_configuration,
    not_modified,
    not_device_owner_error,
    no_transformation_defined,
    object_lock_configuration_not_found_error,
    ownership_controls_not_found_error,
    permanent_redirect_control_error,
    response_interrupted,
    token_code_invalid_error,
    too_many_multi_region_access_pointregions_error,
    too_many_multi_region_access_points,
