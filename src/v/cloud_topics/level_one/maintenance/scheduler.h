 ...
 * - A `log_maintenance_queue` which is populated with shared pointers to managed
 ...
 * which individually pull compaction work from the `log_maintenance_queue` on
...
private:
    ...
    log_maintenance_queue _compaction_queue;
