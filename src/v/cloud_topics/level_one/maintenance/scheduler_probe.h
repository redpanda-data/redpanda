...
class maintenance_scheduler_probe {
public:
    maintenance_scheduler_probe() = default;

    maintenance_scheduler_probe(const maintenance_scheduler_probe&) = delete;
    maintenance_scheduler_probe&
    operator=(const maintenance_scheduler_probe&) = delete;
    maintenance_scheduler_probe(maintenance_scheduler_probe&&) = delete;
    maintenance_scheduler_probe&
    operator=(maintenance_scheduler_probe&&) = delete;
    ~maintenance_scheduler_probe() = default;
    ...
    void log_leveled() { ++_log_levelings; }
