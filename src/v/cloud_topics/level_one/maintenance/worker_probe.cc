...
void maintenance_worker_probe::setup_metrics() {
    ...
    _metrics.add_group(
      prometheus_sanitize::metrics_name("cloud_topics:maintenance_worker"),
      {
        sm::make_counter(
        ...
        sm::make_counter(
          ...
          sm::description(
            "Number of batches removed by compaction across all cloud topic "
            "partitions on this shard")),
        sm::make_gauge(
          "records_removed",
          [this] { return _records_removed; },
          sm::description(
            "Number of records removed by compaction across all cloud topic "
            "partitions on this shard")),
        sm::make_gauge(
          "tombstones_removed",
          [this] { return _tombstones_removed; },
          sm::description(
            "Number of tombstone records removed by compaction across all "
            "cloud topic partitions on this shard")),
        sm::make_histogram(
