...
class maintenance_worker_probe {
public:
    using hist_t = log_hist_internal;
    maintenance_worker_probe() = default;

    maintenance_worker_probe(const maintenance_worker_probe&) = delete;
    maintenance_worker_probe&
    operator=(const maintenance_worker_probe&) = delete;
    maintenance_worker_probe(maintenance_worker_probe&&) = delete;
    maintenance_worker_probe& operator=(maintenance_worker_probe&&) = delete;
    ~maintenance_worker_probe() = default;
