...
public:
    ...
    ss::future<rpc::get_leveling_info_reply> get_leveling_info(
      rpc::get_leveling_info_request, local_only = local_only::no);
...
private:
    ...
    ss::future<rpc::get_leveling_info_reply> get_leveling_info_locally(
