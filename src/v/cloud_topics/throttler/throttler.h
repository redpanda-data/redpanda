...
private:
    ...
    ///
    /// Move some write requests into the '_throttled'
    /// list. This makes them unavailable for other
    /// pipeline consumers and effectively throttles the
    /// workload.
    ...
    // List of throttled write requests
    chunked_vector<write_req_ptr> _throttled;
    ss::abort_source _as;
    ss::gate _gate;
