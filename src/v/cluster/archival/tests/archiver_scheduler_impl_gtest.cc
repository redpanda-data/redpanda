...
TEST_CORO(archiver_scheduler_impl_test, test_backoff_on_error) {
    ...
    // First call
    auto fut1 = scheduler.maybe_suspend_upload(upload_resource_usage{
      .ntp = expected_ntp,
      .put_requests_used = 2,
      .uploaded_bytes = 20,
    ...
    // second call
    auto fut2 = scheduler.maybe_suspend_upload(upload_resource_usage{
      .ntp = expected_ntp,
      .put_requests_used = 3,
      .uploaded_bytes = 30,
      .errc = error_outcome::not_enough_data,
    ...
    auto fut3 = scheduler.maybe_suspend_upload(upload_resource_usage{
      .ntp = expected_ntp,
      .put_requests_used = 4,
      .uploaded_bytes = 40,
      .errc = error_outcome::not_enough_data,
...
TEST_CORO(archiver_scheduler_impl_test, test_bypass_on_success) {
    ...
    auto fut = scheduler.maybe_suspend_upload(upload_resource_usage{
      .ntp = expected_ntp,
      .put_requests_used = 2,
      .uploaded_bytes = 20,
      .errc = {},
