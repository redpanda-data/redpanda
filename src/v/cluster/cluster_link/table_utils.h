...
ss::future<::cluster_link::model::link_state>
copy_link_state(const ::cluster_link::model::link_state& old);

::cluster_link::model::link_configuration
copy_link_configuration(const ::cluster_link::model::link_configuration& old);
...
ss::future<ss::lw_shared_ptr<::cluster_link::model::metadata>>
copy_metadata(const ::cluster_link::model::metadata*);
} // namespace cluster::cluster_link
