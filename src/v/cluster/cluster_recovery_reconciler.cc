...
controller_snapshot_reconciler::get_actions(
  cluster::controller_snapshot& snap) const {
    ...
    auto has_configured_license = existing_license
                                  && existing_license->source
                                       != security::source_type::autogenerated;
    if (
      cur_stage < recovery_stage::recovered_license && !has_configured_license
