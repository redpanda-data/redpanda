...
public:
    ...
    ss::sharded<data_migration_frontend>& get_data_migration_frontend() {
...
private:
    ...
    ss::sharded<data_migrated_resources> _data_migrated_resources;
    std::unique_ptr<data_migration_table> _data_migration_table;
    ...
    ss::sharded<data_migration_frontend> _data_migration_frontend;
    ...
    std::unique_ptr<data_migration_backend> _data_migration_backend;
    ss::gate _gate;
