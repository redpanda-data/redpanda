...
FIXTURE_TEST(test_decommissioned_realloc, partition_allocator_tester) {
    ...
    // reallocate
    auto first_attempt = pa.reallocate_decommissioned_replicas(assignment);
    ...
    auto second_attempt = pa.reallocate_decommissioned_replicas(assignment);
...
FIXTURE_TEST(
  test_decommissioned_realloc_single_replica, partition_allocator_tester) {
    ...
    auto reallocated = pa.reallocate_decommissioned_replicas(assignment);
