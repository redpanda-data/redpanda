...
cluster::allocation_request make_allocation_request(
  ...
  bool topic_aware) {
    ...
    cluster::allocation_request req(tp_ns, cluster::get_allocation_domain(tp_ns));
...
cluster::allocation_request make_allocation_request(
  ...
  const cluster::create_partitions_configuration& cfg) {
    ...
    cluster::allocation_request req(cfg.tp_ns, cluster::get_allocation_domain(cfg.tp_ns));
...
cluster::allocation_request make_allocation_request(
  ...
  const std::vector<model::node_id>& new_replicas) {
    ...
    cluster::allocation_request req(nt, cluster::get_allocation_domain(nt));
