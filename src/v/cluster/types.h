...
#include "cluster/types_acl.h"
#include "cluster/types_mirror.h"
#include "cluster/types_node.h"
#include "cluster/types_partition_state.h"
#include "cluster/types_plugin.h"
...
struct incremental_topic_updates
  : serde::envelope<
    ...
    property_update<model::iceberg_mode> iceberg_mode{
      model::iceberg_mode{}, incremental_update_operation::none};
