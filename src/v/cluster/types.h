...
// used in topic_manifest to enable safely reading topic_manifest generated by
// previous version. please keep it in sync
constexpr static auto topic_properties_version_for_v23_3 = serde::version_t{6};
constexpr static auto topic_properties_version_for_v24_1 = serde::version_t{8};
struct topic_properties
  : serde::envelope<
      topic_properties,
      serde::version<topic_properties_version_for_v24_1>,
      serde::compat_version<0>> {
