...
configuration::configuration()
  ...
  , data_transforms_per_core_memory_reservation(
      *this,
      ...
      meta{
        .needs_restart = needs_restart::yes,
        .example = "2500000000", // std::to_string(25_MiB),
        .visibility = visibility::user,
  ...
  , data_transforms_per_function_memory_limit(
      *this,
      ...
      meta{
        .needs_restart = needs_restart::yes,
        .example = "500000000", // std::to_string(5_MiB),
        .visibility = visibility::user,
  ...
  , default_window_sec(
    ...
    meta  {.needs_restart = needs_restart::no, .visibility = visibility::tunable},
  ...
  meta    {.example = "5000", .visibility = visibility::tunable},
      3'000ms)
 ...
 meta     {.visibility = visibility::user},
  ...
  meta    {.needs_restart = needs_restart::yes, .visibility = visibility::tunable},
      false)
 ...
 meta     {.needs_restart = needs_restart::no, .visibility = visibility::tunable},
  ...
  meta    {.example = "32768", .visibility = visibility::tunable},
      16_KiB,
 ...
 meta     {.visibility = visibility::tunable},
  ...
  , kafka_rpc_server_stream_recv_buf(
      *this,
      ...
      "not applied.",
  meta    {.example = "65536", .visibility = visibility::tunable},
      std::nullopt,
  ...
  meta    {.visibility = visibility::user, .secret = is_secret::yes},
      std::nullopt,
      &validate_non_empty_string_opt)
...
meta      {.needs_restart = needs_restart::no, .visibility = visibility::tunable},
  ...
  , sampled_memory_profile(
      *this,
      ...
      "sites.",
   meta   {// Enabling/Disabling this dynamically doesn't make much sense as for the
