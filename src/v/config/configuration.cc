...
configuration::configuration()
  ...
  , cloud_storage_recovery_topic_force_override_cfg(
      *this,
      "cloud_storage_recovery_topic_force_override_cfg",
      "If True, force validation to ignore the recovery_checks topic property, "
      "and instead use cluster config values "
      "`cloud_storage_recovery_topic_validation_mode` and "
      "`cloud_storage_recovery_topic_validation_depth`",
      {.needs_restart = needs_restart::no, .visibility = visibility::tunable},
      false)
