...
private:
    ...
    boost::intrusive::
      list<binding<T>, boost::intrusive::constant_time_size<false>>
        _bindings;
 ...
 */
using intrusive_auto_unlink = boost::intrusive::list_base_hook<
  boost::intrusive::link_mode<boost::intrusive::auto_unlink>>;

template<class T>
class binding : public intrusive_auto_unlink {
private:
    T _value;
...
public:
    ...
    binding(const binding<T>& rhs) = default;
