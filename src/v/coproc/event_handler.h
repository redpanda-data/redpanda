...
class event_handler_exception final : public std::exception {
public:
...
public:
    ...
    virtual ss::future<event_handler::cron_finish_status> cron() = 0;
...
class async_event_handler : public event_handler {
public:
    explicit async_event_handler(ss::sharded<pacemaker>& pacemaker);

    ss::future<> start() override;
    ss::future<> stop() override;

    ss::future<event_handler::cron_finish_status> cron() override;
...
class data_policy_event_handler : public event_handler {
public:
    ss::future<> start() override;
    ss::future<> stop() override;
