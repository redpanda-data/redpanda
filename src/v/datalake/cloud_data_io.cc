...
cloud_data_io::upload_data_file(
  ...
  lazy_abort_source& lazy_abort_source) {
    ...
    if (upload_result != cloud_io::upload_result::success) {
        vlog(
          datalake_log.error, "Uploading file {} failed - {}", upload_result);
