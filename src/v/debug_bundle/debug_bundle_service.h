 ...
 */
class debug_bundle_service final
  : public ss::peering_sharded_service<debug_bundle_service> {
public:
     ...
     */
    explicit debug_bundle_service(const std::filesystem::path& data_dir);
    /**
...
private:
    ...
    /// Path to the RPK binary
    std::filesystem::path _rpk_path;
};
} // namespace debug_bundle
