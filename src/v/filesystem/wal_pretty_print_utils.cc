...
ostream& operator<<(ostream& o, const wal_header& h) {
    ...
    // as it will cause a sigsev since the enum size is not checked in
    // flatbuffers
...
ostream& operator<<(ostream& o, const wal_get_request& r) {
    o << "wal_get_request={ ns=" << r.ns() << ", topic=" << r.topic()
      << ", partition=" << r.partition() << ", offset=" << r.offset()
      << ", max_bytes=" << r.max_bytes() << " } ";
    return o;
}
ostream& operator<<(ostream& o, const wal_get_reply& r) {
...
ostream& operator<<(ostream& o, const wal_put_partition_records& r) {
    o << "wal_put_partition_records={partition=" << r.partition()
      << ", records(" << r.records()->size() << ")} ";
    return o;
}
ostream& operator<<(ostream& o, const wal_put_request& r) {
...
ostream& operator<<(ostream& o, const wal_put_reply& r) {
...
ostream& operator<<(ostream& o, const wal_binary_record& r) {
    o << "wal_binary_record={ data(size): " << r.data()->size() << "} ";
    return o;
}
ostream& operator<<(ostream& o, const wal_binary_recordT& r) {
...
ostream& operator<<(ostream& o, const wal_put_reply_partition_tuple& t) {
    o << "wal_put_reply_partition_tuple={ partition=" << t.partition()
      << ", start_offset=" << t.start_offset()
      << ", end_offset=" << t.end_offset() << " }";
    return o;
}
ostream& operator<<(ostream& o, const wal_put_reply_partition_tupleT& t) {
