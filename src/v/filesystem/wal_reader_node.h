...
public:
    ...
    struct read_exactly_req {
        ...
        read_exactly_req(read_exactly_req&& o) noexcept
          : relative_offset(o.relative_offset)
          , size(o.size)
          , buf(std::move(o.buf))
          , consumed(o.consumed) {
        }
        read_exactly_req& operator=(read_exactly_req&& o) noexcept {
            if (this != &o) {
        ...
        inline int64_t consume_offset() const {
            return relative_offset + consumed;
        }
        inline int64_t size_left_to_consume() const {
