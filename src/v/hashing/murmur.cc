...
uint32_t
murmurhash3_x86_32(const void *key, std::size_t len, uint32_t seed) {
...
void
murmurhash3_x86_128(const void *key, std::size_t len, void *out,
                    uint32_t seed) {
  const uint8_t *data = (const uint8_t *)key;
...
void
murmurhash3_x64_128(const void *key, std::size_t len, void *out,
                    uint32_t seed) {
  const uint8_t *data = (const uint8_t *)key;
  const int nblocks = len / 16;
