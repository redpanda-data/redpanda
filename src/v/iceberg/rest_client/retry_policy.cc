...
const auto retriable_statuses = std::to_array(
...
retry_policy::result_t default_retry_policy::should_retry(
  ss::future<http::collected_response> response_f) const {
...
default_retry_policy::should_retry(http::collected_response response) const {
