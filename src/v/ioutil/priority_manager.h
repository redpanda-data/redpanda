...
public:
    ...
    inline const io_priority_class& commitlog_priority() {
        return commitlog_priority_;
    }
    inline const io_priority_class& compaction_priority() {
        return compaction_priority_;
    }
    inline const io_priority_class& streaming_read_priority() {
        return stream_read_priority_;
    }
    inline const io_priority_class& streaming_write_priority() {
        return stream_write_priority_;
    }
    inline const io_priority_class& default_priority() {
