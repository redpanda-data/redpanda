...
constexpr std::string_view error_code_names[] = {
  ...
  [(int16_t)error_code::unknown_topic_or_partition] =
  ...
  [(int16_t)error_code::offset_metadata_too_large] =
    "offset_metadata_too_large",
  [(int16_t)error_code::network_exception] = "network_exception",
  [(int16_t)error_code::coordinator_load_in_progress] =
    "coordinator_load_in_progress",
  [(int16_t)error_code::coordinator_not_available] =
  ...
  [(int16_t)error_code::not_enough_replicas_after_append] =
  ...
  [(int16_t)error_code::inconsistent_group_protocol] =
  ...
  [(int16_t)error_code::invalid_commit_offset_size] =
    "invalid_commit_offset_size",
  [(int16_t)error_code::topic_authorization_failed] =
    "topic_authorization_failed",
  [(int16_t)error_code::group_authorization_failed] =
    "group_authorization_failed",
  [(int16_t)error_code::cluster_authorization_failed] =
    "cluster_authorization_failed",
  [(int16_t)error_code::invalid_timestamp] = "invalid_timestamp",
  [(int16_t)error_code::unsupported_sasl_mechanism] =
  ...
  [(int16_t)error_code::invalid_replication_factor] =
    "invalid_replication_factor",
  [(int16_t)error_code::invalid_replica_assignment] =
  ...
  [(int16_t)error_code::unsupported_for_message_format] =
    "unsupported_for_message_format",
  [(int16_t)error_code::policy_violation] = "policy_violation",
  [(int16_t)error_code::out_of_order_sequence_number] =
    "out_of_order_sequence_number",
  [(int16_t)error_code::duplicate_sequence_number] =
  ...
  [(int16_t)error_code::invalid_producer_id_mapping] =
    "invalid_producer_id_mapping",
  [(int16_t)error_code::invalid_transaction_timeout] =
    "invalid_transaction_timeout",
  [(int16_t)error_code::concurrent_transactions] = "concurrent_transactions",
  [(int16_t)error_code::transaction_coordinator_fenced] =
    "transaction_coordinator_fenced",
  [(int16_t)error_code::transactional_id_authorization_failed] =
  ...
  [(int16_t)error_code::sasl_authentication_failed] =
  ...
  [(int16_t)error_code::delegation_token_auth_disabled] =
    "delegation_token_auth_disabled",
  [(int16_t)error_code::delegation_token_not_found] =
    "delegation_token_not_found",
  [(int16_t)error_code::delegation_token_owner_mismatch] =
    "delegation_token_owner_mismatch",
  [(int16_t)error_code::delegation_token_request_not_allowed] =
    "delegation_token_request_not_allowed",
  [(int16_t)error_code::delegation_token_authorization_failed] =
  ...
  [(int16_t)error_code::fetch_session_id_not_found] =
    "fetch_session_id_not_found",
  [(int16_t)error_code::invalid_fetch_session_epoch] =
  ...
  [(int16_t)error_code::unsupported_compression_type] =
  ...
  [(int16_t)error_code::preferred_leader_not_available] =
