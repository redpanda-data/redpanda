...
//   optional string my_file_option_b = 50008 [(my_field_option_b) = 5.5,
//   (my_field_option_a) = 4.5]; optional string my_file_option_a = 50000;
...
//
//   optional int32 foo = 1 [(my_field_option_b) = 5.5, (my_field_option_a)
//   = 4.5]; optional string bar = 2; oneof qux {
...
//     declaration = { full_name: ".some_other_int32", type: "int32", number:
//     555 }, declaration = { full_name: ".some_double", type: "double", number:
//     556, reserved: true }, declaration = { full_name: ".my_message", type:
//     ".SimpleMessage", number: 557, reserved: true, repeated: false }
//   ];
//   extensions 777 [(my_range_option_b) = "some value", (my_range_option_a) =
//   "some other value"];
// }
...
//   extensions 11 to 99 [verification = UNVERIFIED];
//   extensions 111 to 222 [verification = DECLARATION];
//   extensions 333 to 444 [declaration = {number : 334 , full_name :
//   ".some_int" , type : "int32" , repeated : true
//   }];
//   extensions 555 to 666 [
//     declaration = {full_name : ".some_other_int32" , type : "int32" , number
//     : 555
//   },
//     declaration = {full_name : ".some_double" , type : "double" , number :
//     556 , reserved : true
//   },
//     declaration = {full_name : ".my_message" , type : ".SimpleMessage" ,
//     number : 557 , reserved : true , repeated : false
//   }
//   ];
...
//)"));
//     BOOST_CHECK_EQUAL(
//       normalize(schema, pps::protobuf_renderer_v2::yes), (R"(syntax =
//       "proto3";
// package foo;
//
// import "google/protobuf/api.proto";
...
//)";
//     BOOST_CHECK_EQUAL(
//       normalize(schema, pps::protobuf_renderer_v2::yes),
//       expected_normalized);
// }
//
...
//  NestedEnum repeated_nested_enum = 24 [deprecated = false, retention =
//  RETENTION_SOURCE];
//
