...
struct probe_schema_value_handler : public pps::schema_value_handler<> {
    ...
    bool ChunkedString(::json::SizeType len) {
        *chunked_string_used = true;
        return pps::schema_value_handler<>::ChunkedString(len);
    }
...
BOOST_AUTO_TEST_CASE(test_storage_schema_value_large_schema) {
