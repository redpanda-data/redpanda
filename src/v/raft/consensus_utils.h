...
/// payload) or if the batch cannot be decoded. Never throws: this is used
/// by storage to rebuild segment term spans during log recovery, where
/// undecodable batches simply provide no term information.
