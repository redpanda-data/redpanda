...
PERF_TEST_C(fixture, test_new_hb_request_full) {
    ...
    co_await serde::write_async(buffer, new_req_full.copy());
...
PERF_TEST_C(fixture, test_new_hb_request_mixed) {
    ...
    co_await serde::write_async(buffer, new_req_mixed.copy());
...
PERF_TEST_C(fixture, test_new_hb_request_lw) {
    ...
    co_await serde::write_async(buffer, new_req_lw.copy());
...
PERF_TEST_C(fixture, test_new_hb_reply_full) {
    ...
    co_await serde::write_async(buffer, new_reply_full.copy());
...
PERF_TEST_C(fixture, test_new_hb_reply_mixed) {
    ...
    co_await serde::write_async(buffer, new_reply_mixed.copy());
...
PERF_TEST_C(fixture, test_new_hb_reply_lw) {
    ...
    co_await serde::write_async(buffer, new_reply_lw.copy());
