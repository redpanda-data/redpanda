        ...
        return ss::async([this, &cfg] {
            try {
                ...
                install_oneshot_signal_handler<
                  SIGSEGV,
                  crash_tracker::record_sigsegv_crash>();
                install_oneshot_signal_handler<
                  SIGABRT,
                  crash_tracker::record_sigabrt_crash>();
                install_oneshot_signal_handler<
                  SIGILL,
                  crash_tracker::record_sigill_crash>();
...
void application::schedule_crash_tracker_file_cleanup() {
    ...
    _deferred.emplace_front(
      [&] { crash_tracker::record_clean_shutdown().get(); });
}
