...
void cli_opts(boost::program_options::options_description_easy_init o) {
    ...
    o("qps",
      po::value<int32_t>()->default_value(300),
      "number of request per second measured with coordinated ommision");

    o("seconds-duration",
      po::value<int32_t>()->default_value(10),
    ...
    o("key-size",
      po::value<int32_t>()->default_value(50),
