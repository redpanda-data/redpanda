      ...
      , app_signal(std::make_unique<::stop_signal>()) {
        ...
        proto
          .start(
            ...
            std::ref(app.metadata_cache.underlying()),
            ...
            std::ref(app.quota_mgr.underlying()),
            std::ref(app.snc_quota_mgr.underlying()),
            std::ref(app.group_router.underlying()),
            std::ref(app.usage_manager.underlying()),
            std::ref(app.shard_table.underlying()),
            std::ref(app.partition_manager.underlying()),
            std::ref(app.id_allocator_frontend.underlying()),
            std::ref(app.controller->get_credential_store()),
            std::ref(app.controller->get_authorizer()),
            std::ref(app.audit_mgr.underlying()),
            std::ref(app.controller->get_oidc_service()),
            std::ref(app.controller->get_security_frontend()),
            std::ref(app.controller->get_api()),
            std::ref(app.tx_gateway_frontend.underlying()),
            std::ref(app.datalake_throttle_manager.underlying()),
            std::nullopt,
