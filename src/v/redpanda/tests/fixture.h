      ...
      , app_signal(std::make_unique<::stop_signal>()) {
        ...
        proto
          .start(
            ...
            std::ref(app.metadata_cache.as_underlying()),
            ...
            std::ref(app.quota_mgr.as_underlying()),
            std::ref(app.snc_quota_mgr.as_underlying()),
            std::ref(app.group_router.as_underlying()),
            std::ref(app.usage_manager.as_underlying()),
            std::ref(app.shard_table.as_underlying()),
            std::ref(app.partition_manager.as_underlying()),
            std::ref(app.id_allocator_frontend.as_underlying()),
            std::ref(app.controller->get_credential_store()),
            std::ref(app.controller->get_authorizer()),
            std::ref(app.audit_mgr.as_underlying()),
            std::ref(app.controller->get_oidc_service()),
            std::ref(app.controller->get_security_frontend()),
            std::ref(app.controller->get_api()),
            std::ref(app.tx_gateway_frontend.as_underlying()),
            std::ref(app.datalake_throttle_manager.as_underlying()),
            std::nullopt,
