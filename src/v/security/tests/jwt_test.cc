...
struct auth_test_data {
    ...
    std::vector<security::acl_principal> expected_groups{};
  ...
  // Keycloak example with a single /test-group
{
    ...
    .expected_groups={security::acl_principal{security::principal_type::group, "/parent/child/grandchild"}, security::acl_principal{security::principal_type::group, "/test-group"}},
  },
  // Keycloak example with a single test-group
{
    .now=1765487816,
    ...
    .auth_err=oidc::errc::success,
    .principal=security::acl_principal{security::principal_type::user, "19a45ca1-6f3d-45d1-98f4-08d014318973"},
    .expected_groups={security::acl_principal{security::principal_type::group, "grandchild"}, security::acl_principal{security::principal_type::group, "test-group"}},
...
BOOST_DATA_TEST_CASE(test_oidc_authenticate, bdata::make(oidc_auth_data), d) {
    ...
    BOOST_REQUIRE(
      auth.assume_value().groups.size() == d.expected_groups.size());
