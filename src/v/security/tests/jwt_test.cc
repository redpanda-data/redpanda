...
// TODO: Fix/cleanup this section - this was generated by Claude
...
struct auth_test_data_init {
    ...
    security::group_range expected_groups{};
    security::oidc::principal_mapping_rule mapping{};
    security::oidc::group_claim_policy group_policy{};
};

// Copyable test data struct used by Boost.Test
struct auth_test_data {
    ...
    auth_test_data(auth_test_data_init&& init)
      : now(init.now)
      , jwks(init.jwks)
      , jws(init.jws)
      , issuer(std::move(init.issuer))
      , audience(std::move(init.audience))
      , clock_skew_tolerance(init.clock_skew_tolerance)
      , auth_err(init.auth_err)
      , principal(std::move(init.principal))
      , expected_groups(std::move(init.expected_groups))
      , mapping(std::move(init.mapping))
      , group_policy(std::move(init.group_policy)) {}

    // Copy constructor - needed because group_range is non-copyable by default
    auth_test_data(const auth_test_data& other)
      : now(other.now)
      , jwks(other.jwks)
      , jws(other.jws)
      , issuer(other.issuer)
      , audience(other.audience)
      , clock_skew_tolerance(other.clock_skew_tolerance)
      , auth_err(other.auth_err)
      , principal(other.principal)
      , expected_groups(other.expected_groups.copy())
      , mapping(other.mapping)
      , group_policy(other.group_policy) {}

    // Copy assignment operator
    auth_test_data& operator=(const auth_test_data& other) {
        if (this != &other) {
            now = other.now;
            jwks = other.jwks;
            jws = other.jws;
...
const auto oidc_auth_data = std::to_array<auth_test_data_init>({
  ...
  {
    .now=1695887942,
    .jwks=R"({"keys":[{"kty":"RSA","use":"sig","n":"zs8Zk1hD9hh8XGfXy21K5yzreZf7R9vYTQTNVGKdDDHfB7YRbC1FRwi6pGca3ElQHtH5l4S93MUaQtkN8JYI-5YyGzxBOVyiwdc_qJ-jNWYzVdZX7PuCo-h3ikBJkD5N9f9b-zv0c_uHhtluzHQkhaCxVJn5t4XQ5HAm1qfxJgotVXbrTDGAdZEh7p5RI2kU8RAGE68RLUVsAGXdefs73QGVpM_uGONlqfMQk05ewyS2iqo14MfMwUn60gREk1w7riMGJvddEATe8XfOTZwErsf8ZcExXMVOcBmIn694y1CZx6LimrWIzWynvuC6h8OFCC76I_TiPHqiMaLXqaNabQ","e":"AQAB","kid":"tMQzailSAdaW4nojXxES9","x5t":"_LDYs6FFeEvJ-ng_a5-cxjUYaRw","x5c":[""],"alg":"RS256"},{"kty":"RSA","use":"sig","n":"sP1lZhMdFVBrS06tFjwtuY0oRxDcZ8vPzUyUA5-vULpihTFDM-Jkeskvi3lAsZVkIv8iJVGSqdoBQyr3c27DWfDsUnH1HY1vGI6oB2m61uemCir104P07J6sZwO46hRnjp5vub2vJMjN_o4BOD2XiYXsTLg2gXsuh32HHKOr7ljbEZm4ygLeDVknGsSRIROxRWE8VPWjTQYRktAzwW8SMXI1wWxvg8wI6sKI4ydBMhQHO8ZomcIzdo66H31a45j2Jxn5JxKy-fMJbMg3qfTVh_9FMIOAjdVqtPN1g0TkoI8Y1H_iqkGq7tvqURnHBsbVkxwnaisJFJ1r67P7QnK3pw","e":"AQAB","kid":"NKxtg1GbhZJBVcnBjtSqI","x5t":"ENffeDpSw-aWSjJq0pCEhtDnYP0","x5c":[""],"alg":"RS256"}]})",
    .jws=R"(eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InRNUXphaWxTQWRhVzRub2pYeEVTOSJ9..W6rhgOjWcTPmpeLHiGSd668HHnZJvHgP0QSKU0F1vnin_UMIpei9IONfN28YSHlAabdUs2JAV70AvVeXB9IqUcEi_Cfubf3JRpmRcvfyApnmfcRktg1Rq0DVGVl6uBPlqX12SAQ4GPYe4BysUuMb8X-FU99wF6waCAQw8XLu_Texqy8QOQhW9vZtm5HC54-APn9PV6ZAtG989ihePOsauXUHNe2sqF_iJ1_7-nkqRbgb_Je-8UjahAkC54y5LPTMVFQvTB5lntf-sUyHl5oPH7P58M8eNUocOOGADUmrfKMYeSLacM_9mPvZR_uMbVX0iNt18KO6hKkIvAPrb4U8SA)",
    .issuer="https://dev-ltxchcls4igzho78.us.auth0.com/",
    .audience="localhost",
    .clock_skew_tolerance=0s,
    .auth_err=oidc::errc::success,
  ...
  {
    .now=1697645170,
    .jwks=R"({"keys":[{"kid":"EWGWeiW8jqUC_T7Fawi5ecRbrDOanB_uqtTgAOgJDPk","kty":"RSA","alg":"RSA-OAEP","use":"enc","n":"0OceMDMwIZCADl3oZnevxMBzB5GTLwFYevc7PFbw394YY4-Sdt4xqudPMSf2WhU22CidYiMVP1xvcZP7W_5eNLS9nNg3gsswgPiL52ZbWeWoOYx1WDVZzZur3YyjOR1iYvwhR572JumAfDE64y2cHpN2meVana9Zv7S4_yc9pFwGdPTJh7O76lamMjigfYKGF8BKSsFYPkxh_RgaRVqOaaF-CtXPBWmwqvJZ1r0h7GewcP5QeyaUUrZtTo7z0H6VovUGdwguL-OxhWVWZNyGDudtc50PPu3BBn47NpZIa4qCBEsMpm0mJ7YUvwAG-Ktd93uSquJkXvFjaVbTYj_iqQ","e":"AQAB","x5c":[""],"x5t":"2pddNGN6l8gxd7dKncQNOU67zn0","x5t#S256":"08bCcr5IDx1OPuLJcT3t5rSeJbY7Y1JHPF-aBCQfdio"},{"kid":"kf46eDlB9jtz2PpktQ6NQSfRwoU_tT3NqxlI8C4MGvQ","kty":"RSA","alg":"RS256","use":"sig","n":"3yqePLS9Q5Nf-q-ujodgMbblIwwPsEUCcXSxBS0eqrrSTNuPaHr-v_y_yyfKfxqhEmK_MBVvlXXmmwWZk6rWlR2hSdQW6Ih7UWLVaNOT35slcCfjQWQa3O0ZHxzemhgj0HHQ9x8t_AcK1wJd_hMjl3qwG12V1l-9-vSVIOrnl47YXC57K_j8MuNBPr1YdD4Rm9GGFxPQPRpc3nxTO2tFkkeGubfN6eJ226OvaA1uP6SlZEeA4KSjd-Bl0AAKotKcF9orHOuiceAarKs6uGZ84GocGaUtEEOli4e5bJrnNOXZDzCo34VdhFXFmJ2vU3g1XkY8e9wgA0fs9b3OhjqXIw","e":"AQAB","x5c":[""],"x5t":"8pMnWd5FLQJEK-62faplcAnJg3s","x5t#S256":"RiXQ3fgtOOATBmwUxB6sCnDP9aTthPtAdHo4ZXj0uPY"}]})",
    .jws=R"(eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJrZjQ2ZURsQjlqdHoyUHBrdFE2TlFTZlJ3b1VfdFQzTnF4bEk4QzRNR3ZRIn0..bYoI1XzW6Bw-dOnPAwBoB3tjM4xrt3loeUgwuipOmcm-yTheLSCf4qK3LOlzmuZdyF7TduDiizl4q8XIDe6XydrYL0tw4ebnQjcQo0wJNSZZQ3olZ65iJUoFHqK0YZuI4a4VDqMq0viEo2c2zFo3reVsr2XTtBgtU-iVyWpvmz6x-CceaGaKZpjDOcS8ixFcpSx-_mraQ18vr2yNHDO1DExg3Pc6FdbaiYApfldR9QIe2Oa5VTlVWXaqmjbFv3dA-FODIznEZ4tiN_8fZz5-BhkTTEupQGbCrYTIhR9rW_2xC_b8MhJCBMVFkMYATxLmJH9WPN5Fnzs2kiP7Xvs_eg)",
    .issuer="http://docker-rp-1:8080/realms/demorealm",
    .audience="myapp",
    .clock_skew_tolerance=0s,
    .auth_err=oidc::errc::success,
    .principal=security::acl_principal{
  ...
  {
    .now=1699213461,
    .jwks=R"({"keys": [{"kty": "RSA", "use": "sig", "kid": "9GmnyFPkhc3hOuR22mvSvgnLo7Y", "x5t": "9GmnyFPkhc3hOuR22mvSvgnLo7Y", "n": "z_w-5U4eZwenXYnEgt2rCN-753YQ7RN8ykiNprNiLl4ilpwAGLWF1cssoRflsSiBVZcCSwUzUwsifG7sbRq9Vc8RFs72Gg0AUwPsJFUqNttMg3Ot-wTqsZtE5GNSBUSqnI-iWoZfjw-uLsS0u4MfzP8Fpkd-rzRlifuIAYK8Ffi1bldkszeBzQbBZbXFwiw5uTf8vEAkH_IAdB732tQAsNXpWWYDV74nKAiwLlDS5FWVs2S2T-MPNAg28MLxYfRhW2bUpd693inxI8WTSLRncouzMImJF4XeMG2ZRZ0z_KJra_uzzMCLbILtpnLA95ysxWw-4ygm3MxN2iBM2IaJeQ", "e": "AQAB", "x5c": [""], "issuer": "https://login.microsoftonline.com/9a95fd9e-005d-487a-9a01-d08c1eab2757/v2.0"}, {"kty": "RSA", "use": "sig", "kid": "lHLIu4moKqzPcokwlfCRPHyjl5g", "x5t": "lHLIu4moKqzPcokwlfCRPHyjl5g", "n": "xlc-u9LJvOdbwAsgsYZpaJrgmrGHaEkoa_3_7Jvu4-Hb8LNtszrQy5Ik4CXgQ_uiLPt4-ePprX3klFAx91ahfd5LwX6mEQPT8WuHMDunx8MaNQrYNVvnOI1L5NxFBFV_6ghi_0d-cOslErcTMML2lbMCSjQ8jwltxz1Oy-Hd9wdY2pz2YC3WR4tHzAGreWGeOB2Vs2NLGv0U3CGSCMqpM9vxbWLZQPuCNpKF93RkxHj5bLng9U_rM6YScacEnTFlKIOOrk4pcVVdoSNNIK2uNUs1hHS1mBXuQjfceghzj3QQYHfp1Z5qWXPRIw3PDyn_1Sowe5UljLurkpj_8m3KnQ", "e": "AQAB", "x5c": [""], "issuer": "https://login.microsoftonline.com/9a95fd9e-005d-487a-9a01-d08c1eab2757/v2.0"}]})",
    .jws=R"(eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI
    .jws=R"(eyJhbGciOiJSUzI1NiIsImtpZCI6ImY1ZjRiZjQ2ZTUyYjMxZDliNjI0OWY3MzA5YWQwMzM4NDAwNjgwY2QiLCJ0eXAiOiJKV1QifQ..gm60Q6OiKzpnmTqh0BrmTkXzyUm2OEUrL8gfA4LBKdzXHucMhlqBA2LaNACv0LH2oqCxwy5BCdCaZWkHhIVJGCLMy7p__c_OO_1VUXwCtr9j2MtQaPPgOK8z1dT8-dmU3xXuWsEl5FX2k3JFiDlSUdgNrFs8o2uuJG_VtiLjV3u4jyHTS-vwcdYbFpH7ipS-bL-g-_uW8-qKAfJqk4V_fWXJ__tjNlvMRogweujpRpa-_1H9Cdk7avlRB_xbthUVFI2guE-0yMGDZhZrjI1vkA9uj1bpcH-85JiGPRlcGuikBnmB3ZUkJ6QffVfa4PwyYV78ybkPjtbcXjcp3X0AjQ)",
  ...
  {
    .now=1699395367,
    .jwks=R"({"keys": [{"kty": "RSA", "alg": "RS256", "kid": "f4-dpAc7AqynmGcjjS9LLPCBEW2ezVfIbAqTHPyKe_Y", "use": "sig", "e": "AQAB", "n": "jRkJD3j3D5Zt2ZutvOxaJvgG9iCAi2NjXMAF8lSwFH_2YDc5XFAuFuvMeJp0O-RRPFuOqltp-TmC9v6b7lJaLbvenAf8YtwS5j1hfwekTDpEDjtDrd_57VsbMqCt8_2aEG5qOO8nMB2bNSNKwWL6OsDf8cZZl_v9ifeFD5L12JIzPaCskhL2SZVuHtUTwcuDgjLTGTVrPVmwJri8ZulmKu8t3DOqwwsr1ezqwcVtNucDxB-GeDKAkUCIdEbTEvpcVaQt-Z4i9AA-9tbXuXOQwLvy8ijt-Kaf0V7527LshRejwFCz7Ifz-orWaGyXbGOQDiJl6-hLd8kI8uTfU3zwWw"}]})",
    .jws=R"(eyJraWQiOiJmNC1kcEFjN0FxeW5tR2NqalM5TExQQ0JFVzJlelZmSWJBcVRIUHlLZV9ZIiwiYWxnIjoiUlMyNTYifQ..Z70D28OtRHmgUZrBQ9XbdEONk-UfdPiGlFAuyREjn3GWVsGi4K9wwvLs8vGgcNR3r1IWBOTXPL-MXtptQDBhRwDkZDQWRUqaoBBul5mHFjSXGeSk1_YM4se4_jH9FZCP0vpavRIlsBpNwiOT9I9I9fkJp9qGA7IQ6LrxezKYpBbQUXcy7bw0oom84ej0ai2zP1_Yphtw6fYgZNOJ8xpf-wtBxzyZgW4Vb3ABnlMcS294h_VR39Cx09yfHXLqVgYactujzXxcAjYD2fCyFWHJ-5ZCZZxHWrM_wToCvoe7vytGTrAbOo2_hLhYw78o6cGXLGoHOe-akCpmGd9HzNIMCg)",
    .issuer="https://dev-69785679.okta.com/oauth2/default",
  ...
  {
    .now=1700152921,
    .mapping=security::oidc::principal_mapping_rule{
      json::Pointer{"/appid"}, security::tls::rule{}},
  },
  // Keycloak example with a single /test-group
{
    .now=1765487816,
    .jwks=R"({"keys": [{"kid": "1uqbhrEumLAj14oxW7NGR6p6jKflq3Hac9y2r-Rxkto", "kty": "RSA", "alg": "RS256", "use": "sig", "x5c": [""], "x5t": "lm88wSRm_nPxFSVbPEdqhOigZsw", "x5t#S256": "HNu1qk2BWOfOwzZW0eeavghyvCiHmLSBOK5StVYeRL8", "n": "9upXBTkPoexSlyftcAdkTQatcx_XK_Vk1Qzne3vARLnICeyXLKG9zTD7S9G6c9Ml0pucRhtW_RIl1YdESiAWBGBPeXvAXqccJxprw-BU7UvPFXbeVsdUOuU8FB5Anr1xoK_D8_Kr81rDoNsQcfSl21Z64AF1OHdataPsfdAxR7EUYGKUOWHJTpDEA_nWmHJn72QqF0i66hVjh-f2i1hudpJGywFwspXR5KNcV89o_UfpD9IcoUI6RlddHaULMDf9YX7IwNoGNGZWSMiMG6KgsYsmwduAyylzoz2dqVluLbLBA0k1poM5oLdGsDECsCmJaX0I-DjfAXHOwD5EnBmZMQ", "e": "AQAB"}]})",
    .jws=R"(eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIxdXFiaHJFdW1MQWoxNG94VzdOR1I2cDZqS2ZscTNIYWM5eTJyLVJ4a3RvIn0..EBmhjP0sC5IzJSWpHTiqtsVK0qkhJr-NZceg-H4Xpyr2mDXADeh5K1AqFg-9PXaobtFEt7uGNeUVLf78ugDPjNvakX6UMng7rCNcrSS6SDR9ATRlHc4xFrgv21Kesd8gujwGpv0TUVVVSBFIvNkZ92X8iDNfy5nbB3M54kYv_o-lPVrErzTRaLGLP5BXv7G_MICYt5KojvtTUzzvPxZgH4nDJpnEHYhtpEIjBD1UScFg5aF7Y5dS-UOvGklAR6d6q7FaqUKZnQ08SHoLmp0DI4noP1wlvZP46jR9zCIOxc2ZHRppG-ff5SIu3Zfv3ixeY2eyDGH8Vw1w1HKj0D6YHA)",
    .issuer="http://localhost:8080/realms/poc",
    .audience="account",
    .clock_skew_tolerance=0s,
    .auth_err=oidc::errc::success,
    .principal=security::acl_principal{security::principal_type::user, "19a45ca1-6f3d-45d1-98f4-08d014318973"},
    .expected_groups=security::group_range{{security::acl_principal{security::principal_type::group, "/parent/child/grandchild"}, security::acl_principal{security::principal_type::group, "/test-group"}}},
  },
  // Keycloak example with a single test-group
{
    .now=1765487816,
    ...
    .auth_err=oidc::errc::success,
    .principal=security::acl_principal{security::principal_type::user, "19a45ca1-6f3d-45d1-98f4-08d014318973"},
    .expected_groups=security::group_range{{{security::acl_principal{security::principal_type::group, "grandchild"}, security::acl_principal{security::principal_type::group, "test-group"}}}},
    .group_policy = security::oidc::group_claim_policy(
        json::Pointer{"/groups"},
...
// Convert to copyable test data for Boost.Test
auto make_oidc_auth_test_data() {
...
BOOST_DATA_TEST_CASE(
  test_oidc_authenticate, bdata::make(make_oidc_auth_test_data()), d) {
    ...
    for (const auto& g : d.expected_groups) {
        BOOST_REQUIRE(std::ranges::contains(auth.assume_value().groups, g));
    }
}
