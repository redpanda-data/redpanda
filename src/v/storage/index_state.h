...
public:
    ...
    /// Pop back one element. This is inefficient with columnar format but
    /// it's not invoked often and when it is invoked it usually invoked
    /// only a few times.
...
private:
    ...
    using pos_column_t = deltafor_column<
      ...
      position_index_step>;
    using time_column_t = deltafor_column<uint64_t, details::delta_xor, 0>;
    ...
    time_column_t _relative_time_index;
