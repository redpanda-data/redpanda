...
class MuService:
    ...
    def start(self, service, nodes):
        raise NotImplementedError("%s: subclasses must implement start_node." % self.__class__.__name__)

    def stop_node(self, service, node):
        raise NotImplementedError("%s: subclasses must implement stop_node." % self.__class__.__name__)

    def clean_node(self, service, node):
        raise NotImplementedError("%s: subclasses must implement clean_node." % self.__class__.__name__)
