...
class LevelZeroGcServiceClient:
    ...
    def call_get_epoch(self, req: proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest, extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None) -> UnaryOutput[proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse]:
        """Low-level method to call GetEpoch, granting access to errors and metadata"""
        url = self.base_url + '/redpanda.core.admin.internal.cloud_topics.v1.LevelZeroGcService/GetEpoch'
        return self._connect_client.call_unary(url, req, proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse, extra_headers, timeout_seconds)

    def get_epoch(self, req: proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest, extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None) -> proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse:
        response = self.call_get_epoch(req, extra_headers, timeout_seconds)
        err = response.error()
        if err is not None:
            raise err
        msg = response.message()
...
class AsyncLevelZeroGcServiceClient:
    ...
    async def call_get_epoch(self, req: proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest, extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None) -> UnaryOutput[proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse]:
        """Low-level method to call GetEpoch, granting access to errors and metadata"""
        url = self.base_url + '/redpanda.core.admin.internal.cloud_topics.v1.LevelZeroGcService/GetEpoch'
        return await self._connect_client.call_unary(url, req, proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse, extra_headers, timeout_seconds)

    async def get_epoch(self, req: proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest, extra_headers: HeaderInput | None=None, timeout_seconds: float | None=None) -> proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse:
        response = await self.call_get_epoch(req, extra_headers, timeout_seconds)
        err = response.error()
        if err is not None:
            raise err
        msg = response.message()
...
class LevelZeroGcServiceProtocol(typing.Protocol):
    ...
    def get_epoch(self, req: ClientRequest[proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest]) -> ServerResponse[proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochResponse]:
        ...
...
def wsgi_level_zero_gc_service(implementation: LevelZeroGcServiceProtocol) -> WSGIApplication:
    ...
    app.register_unary_rpc('/redpanda.core.admin.internal.cloud_topics.v1.LevelZeroGcService/GetEpoch', implementation.get_epoch, proto.redpanda.core.admin.internal.cloud_topics.v1.level_zero_gc_pb2.GetEpochRequest)
    return app