...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LIFECYCLESTATE']._serialized_start = 1783
    _globals['_LIFECYCLESTATE']._serialized_end = 1914
    ...
    _globals['_COORDINATORRESETTOPICSTATEREQUEST']._serialized_start = 344
    _globals['_COORDINATORRESETTOPICSTATEREQUEST']._serialized_end = 447
    _globals['_COORDINATORRESETTOPICSTATERESPONSE']._serialized_start = 449
    _globals['_COORDINATORRESETTOPICSTATERESPONSE']._serialized_end = 485
    _globals['_COORDINATORSTATE']._serialized_start = 488
    _globals['_COORDINATORSTATE']._serialized_end = 711
    _globals['_COORDINATORSTATE_TOPICSTATESENTRY']._serialized_start = 607
    _globals['_COORDINATORSTATE_TOPICSTATESENTRY']._serialized_end = 711
    _globals['_DATAFILE']._serialized_start = 714
    _globals['_DATAFILE']._serialized_end = 864
    _globals['_TRANSLATEDOFFSETRANGE']._serialized_start = 867
    _globals['_TRANSLATEDOFFSETRANGE']._serialized_end = 1107
    _globals['_PENDINGENTRY']._serialized_start = 1109
    _globals['_PENDINGENTRY']._serialized_end = 1228
    _globals['_PARTITIONSTATE']._serialized_start = 1231
    _globals['_PARTITIONSTATE']._serialized_end = 1376
    _globals['_TOPICSTATE']._serialized_start = 1379
    _globals['_TOPICSTATE']._serialized_end = 1780
    _globals['_TOPICSTATE_PARTITIONSTATESENTRY']._serialized_start = 1668
    _globals['_TOPICSTATE_PARTITIONSTATESENTRY']._serialized_end = 1780
    _globals['_DATALAKESERVICE']._serialized_start = 1917
    _globals['_DATALAKESERVICE']._serialized_end = 2301