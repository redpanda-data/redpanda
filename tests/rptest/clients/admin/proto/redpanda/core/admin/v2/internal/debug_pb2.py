...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'proto/redpanda/core/admin/v2/internal/debug.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DEBUGSERVICE']._serialized_start = 722
    _globals['_DEBUGSERVICE']._serialized_end = 1195