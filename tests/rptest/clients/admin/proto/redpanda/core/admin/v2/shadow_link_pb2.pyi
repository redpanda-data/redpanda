...
class TopicMetadataSyncOptions(google.protobuf.message.Message):
    ...
    PROMOTE_TO_TIERED_CLOUD_ON_FAILOVER_FIELD_NUMBER: builtins.int
    ...
    promote_to_tiered_cloud_on_failover: builtins.bool
    "When true, the link's cloud shadow topics are promoted to tiered_cloud\n    on failover, so the promoted cluster serves reads and writes locally.\n    Off by default; only meaningful when the storage mode is cloud.\n    "
    ...
    def ClearField(self, field_name: typing.Literal['auto_create_shadow_topic_filters', b'auto_create_shadow_topic_filters', 'effective_interval', b'effective_interval', 'exclude_default', b'exclude_default', 'interval', b'interval', 'paused', b'paused', 'promote_to_tiered_cloud_on_failover', b'promote_to_tiered_cloud_on_failover', 'shadow_topic_storage_mode', b'shadow_topic_storage_mode', 'shadow_topic_storage_mode_filters', b'shadow_topic_storage_mode_filters', 'start_at_earliest', b'start_at_earliest', 'start_at_latest', b'start_at_latest', 'start_at_timestamp', b'start_at_timestamp', 'start_offset', b'start_offset', 'synced_shadow_topic_properties', b'synced_shadow_topic_properties']) -> None:
        ...
