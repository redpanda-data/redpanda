...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_TLSPEMSETTINGS'].fields_by_name['key']._serialized_options = b'\x80\x01\x01\xe0A\x04'
    ...
    _globals['_TLSPEMSETTINGS']._serialized_end = 530