...
from rptest.services.redpanda_types import PLAINTEXT_SECURITY, InvalidKafkaSecurity, KafkaClientSecurity, check_username_password
...
class RpkTool:
    ...
    def __init__(self,
        ...
        # if sasl_set and tls_cert:
        #     raise InvalidKafkaSecurity(
        #         'both SASL and mTLS properties were set on the tool')
        ...
        if not sasl_set and tls_cert:
            ...
            self._security = PLAINTEXT_SECURITY.override_tls(tls_enabled)
        else:
