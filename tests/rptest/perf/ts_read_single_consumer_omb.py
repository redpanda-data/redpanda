...
class TSReadSingleConsumerOMBTest(RedpandaPerfTest):
    ...
    def __init__(self, ctx: TestContext):
        ...
        self._ctx = ctx
        super(TSReadSingleConsumerOMBTest, self).__init__(
            test_context=ctx,
            num_brokers=3,
    ...
    def test_perf(self, driver_idx: str):
        """
        A single consumer OMB perf regression test that has TS reads.

        This is included in the regression test suite in addition to a multi-consumer
        regression test as it is common to do historical reads with a single consumer.
        """
        ...
        workload = {
            "name": "TSReadSingleConsumerWorkload",
            "topics": 1,
        ...
        benchmark_time_min = (
            ...
            + TSReadSingleConsumerOMBTest.BENCHMARK_WAIT_TIME_MIN
        )
