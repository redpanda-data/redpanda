...
class Admin:
    ...
    def unsafe_reset_cloud_metadata(self, topic, partition, manifest_json):
        return self._request('PUT', f"cloud_storage/unsafe_reset_metadata/{topic}/{partition}", json=manifest_json)
