...
# TODO: Refactor with ProducerSwarm to have class hierachy instead of copy/pasted code
...
class ConsumerSwarm(Service):
    ...
    def start_node(self, node, clean=None):
        # Example client-swarm consumer help
        # -c, --count <COUNT>
        # -g, --group <GROUP>
        # -h, --help                             Print help information
        # -m, --messages <MESSAGES>
        # -p, --properties <PROPERTIES>
        # -s, --static-prefix <STATIC_PREFIX>    if set uses static group membership protocol
        # -t, --topic <TOPIC>
        # -u, --unique-topics
        ...
        self._redpanda.wait_until(
            ...
            backoff_sec=1,
            err_msg=
            f"consumer_swarm service {node.account.hostname} failed to start within {600} sec",
        )
