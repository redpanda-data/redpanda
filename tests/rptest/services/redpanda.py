...
class LoggingConfig:
    ...
    def to_args(
            self,
            redpanda_version: Optional[Tuple[int, int, int]] = None) -> str:
        """
        ...
        If a logger is not present in the dictionary, we assume it was always
        supported/does not require special handling.
