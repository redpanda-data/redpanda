...
class CloudArchiveRetentionTest(RedpandaTest):
    ...
    def test_delete(self, cloud_storage_type, retention_type):
        ...
        wait_until(
            ...
            timeout_sec=100,
            backoff_sec=5,
            err_msg=f"Segments were not removed from the cloud, expected {segments_to_delete} deletions",
        )
        ...
        wait_until(
            ...
            timeout_sec=120,
            backoff_sec=5,
            err_msg=f"Segments were not removed from the cloud, expected {segments_to_delete} "
