...
class ShadowLinkingCloudTopicStorageModeOverrideTests(ShadowLinkPreAllocTestBase):
    ...
    def create_link_with_storage_mode_override(
        ...
        promote_to_tiered_cloud_on_failover flag, which promotes the link's
        ...
        req.shadow_link.configurations.topic_metadata_sync_options.promote_to_tiered_cloud_on_failover = promote_on_failover
    ...
    def test_failover_no_promotion_when_promotion_disabled(self):
        ...
        promote_to_tiered_cloud_on_failover (default off). With it disabled,
        ...
        try:
            ...
            assert False, (
                ...
                "though promote_to_tiered_cloud_on_failover was disabled"
            )
