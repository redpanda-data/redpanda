...
from rptest.tests.data_migrations import DataMigrationsTestBase as Base, make_namespaced_topic, now
...
class DataMigrationsApiTest(Base):
    ...
    @cluster(num_nodes=3, log_allow_list=Base.MIGRATION_LOG_ALLOW_LIST)
    ...
    @cluster(
        num_nodes=3,
        log_allow_list=Base.MIGRATION_LOG_ALLOW_LIST + [
    ...
    def test_creating_and_listing_migrations(self):
        self.do_test_creating_and_listing_migrations(5, 3)
