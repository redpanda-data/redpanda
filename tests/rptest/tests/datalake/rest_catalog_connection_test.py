...
class RestCatalogConnectionTest(RedpandaTest):
    ...
    @cluster(num_nodes=5)
    @matrix(
        cloud_storage_type=supported_storage_types(), use_serde_parquet=[False, True]
    )
    def test_redpanda_connection_to_rest_catalog(
        self, cloud_storage_type, use_serde_parquet
    ):
