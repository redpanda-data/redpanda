    ...
    def test_describe_topics_with_documentation_and_types(self):
        ...
        properties = {
            ...
            "delete.retention.ms": ConfigProperty(
                config_type="LONG",
                value="-1",
                doc_string="The retention time for tombstone records in a compacted topic. Cannot be enabled at the same time as any of `cloud_storage_enabled`, `cloud_storage_enable_remote_read`, or `cloud_storage_enable_remote_write`.",
            ),
