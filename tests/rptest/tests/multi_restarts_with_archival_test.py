...
class MultiRestartTest(EndToEndTest):
    ...
    def __init__(self, test_context):
        ...
        super(MultiRestartTest, self).__init__(
    ...
    def test_recovery_after_multiple_restarts(self, cloud_storage_type):
        ...
        self.start_redpanda(
            3, extra_rp_conf=self._extra_rp_conf, si_settings=si_settings
        )
        ...
        self.run_validation(
            enable_idempotence=False, producer_timeout_sec=60, consumer_timeout_sec=180
        )
