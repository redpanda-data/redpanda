...
class NodesDecommissioningTest(EndToEndTest):
    ...
    @property
    def node_removed_timeout(self):
        return 240 if self.debug_mode else 120
    ...
    def test_decommissioning_working_node(self):
        ...
        wait_until(
            ...
            timeout_sec=self.node_removed_timeout,
            backoff_sec=2)
    ...
    def test_recommissioning_one_of_decommissioned_nodes(self):
        ...
        wait_until(node_removed, self.node_removed_timeout, 2)
    ...
    def test_multiple_decommissions(self):
        ...
        for i in range(0, 2):
            for b in self.redpanda.nodes:
                ...
                wait_until(lambda: self._node_removed(id, survivor_node),
                           self.node_removed_timeout, 2)
