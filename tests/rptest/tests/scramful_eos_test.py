...
class ScramfulEosTest(RedpandaTest):
    ...
    def __init__(self, test_context):
        ...
        super(ScramfulEosTest, self).__init__(
    ...
    def test_idempotent_write_passes_1(self):
        ...
        self.retry(
            lambda: self.write_by_bob(algorithm),
            5,
    ...
    def test_tx_init_passes_1(self):
        ...
        self.retry(
            lambda: self.init_by_bob("tx-id-1", algorithm),
            5,
            [TRANSACTIONAL_ID_AUTHORIZATION_FAILED],
        )
    ...
    def test_tx_init_passes_2(self):
        ...
        self.retry(
            lambda: self.init_by_bob("tx-id-2", algorithm),
            5,
            [TRANSACTIONAL_ID_AUTHORIZATION_FAILED],
        )
