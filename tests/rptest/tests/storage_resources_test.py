...
class StorageResourceRestartTest(RedpandaTest):
    ...
    def test_recovery_reads(self, clean_shutdown):
        ...
        if self.debug_mode:
            ...
            self.test_contexct.cluster.free_single(nodes[0])
            return
        ...
        # Not enough data per-partition to trigger 64MiB checkpoint
        # thresholds: relies on the central enforcement of dirty data
        # size in storage_resources
