...
class CreateTopicUpgradeTest(RedpandaTest):
    ...
    def test_retention_config_on_upgrade_from_v22_2_to_v22_3(self):
        ...
        # FIXME: this will fail if we flip the order of the alter operations
        # and set retention first then enable shadow indexing.
        # To resolve this robustly we need an enhanced form of upgrade handling that
        # replays the whole controller log and then decides what to tweak.
        ...
        # After upgrade, newly created topics should interpret assignments
        # to retention properties literally (no mapping of retention -> retention.local)
        new_topic_name = "test-topic-post-upgrade"
        self.rpk.create_topic(new_topic_name,
                              config={
                                  "retention.bytes": 10000,
