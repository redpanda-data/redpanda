...
class UsageStatsReportingTest(RedpandaTest):
    ...
    def test_usage_stats_reporting(self, replication_factor):
        ...
        assert (
            ...
            and stats.bytes_read == 0
            and stats.bytes_written == 0
        ...
        bytes_read = stats_after_produce["bytes_read"] - initial_stats["bytes_read"]
        bytes_written = (
            stats_after_produce["bytes_written"] - initial_stats["bytes_written"]
        )
