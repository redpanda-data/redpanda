...
class WriteCachingFailureInjectionE2ETest(RedpandaTest):
    ...
    def test_crash_all(self, use_transactions):
        ...
        for round_ix in range(0, num_restart_rounds + 1):
            ...
            consumer.wait_total_reads(total_produced, timeout_sec=60, backoff_sec=1)
    ...
    def test_crash_all_with_consumer_group(self):
        ...
        for round_ix in range(0, num_restart_rounds + 1):
            ...
            consumer.wait_total_reads(
                num_msg_per_round // 2, timeout_sec=120, backoff_sec=3
            )
            ...
            consumer.wait_total_reads(num_msg_per_round, timeout_sec=120, backoff_sec=3)
            ...
            cumulative_lost_offsets.update(
                collections.Counter(consumer.consumer_status.validator.lost_offsets)
            )
        ...
        self.logger.info(f"Cumulative consumer lost offsets: {cumulative_lost_offsets}")
