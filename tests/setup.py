...
setup(
    ...
    install_requires=[
        'ducktape@git+https://github.com/ivotron/ducktape.git@0.12.x-redpanda',
        ...
        'kafkatest@git+https://github.com/apache/kafka.git@bb7c0830496f5dbb01a29bcf27cb77b7d83fe939#egg=kafkatest&subdirectory=tests',
        'grpcio==1.57.0',
        'grpcio-tools==1.57',
