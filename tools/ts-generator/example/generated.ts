...
export class Class2 {
   ...
   */
  static toBytes(value: Class2, buffer: IOBuf): number {
    let writtenBytes = 0;
...
export class Class3 {
  ...
  static fromBytes(buffer: Buffer, offset = 0): [Class3, number] {
    ...
    const optional = (() => {
      const [optional, newOffset] = BF.readOptional(
        buffer,
        offset,
        (auxBuffer, auxOffset) => BF.readObject(auxBuffer, auxOffset, Class2)
      );
      offset = newOffset;
      return optional;
    })();
   ...
   * @return the last position of the offset
   */
  static toBytes(value: Class3, buffer: IOBuf): number {
    let writtenBytes = 0;
    ...
    writtenBytes += BF.writeOptional(
      buffer,
      value.optional,
      (item, auxBuffer) => BF.writeObject(auxBuffer, Class2, item)
    );
...
export class Class1 {
  ...
  static fromBytes(buffer: Buffer, offset = 0): [Class1, number] {
    ...
    const mixCustomType = (() => {
      const [optional, newOffset] = BF.readOptional(
        ...
        offset,
        (auxBuffer, auxOffset) =>
          BF.readArray()(auxBuffer, auxOffset, (auxBuffer, auxOffset) =>
            BF.readOptional(auxBuffer, auxOffset, (auxBuffer, auxOffset) =>
              BF.readOptional(auxBuffer, auxOffset, (auxBuffer, auxOffset) =>
   ...
   * @return the last position of the offset
   */
  static toBytes(value: Class1, buffer: IOBuf): number {
    let writtenBytes = 0;
    ...
    writtenBytes += BF.writeArray(true)(
      value.arrayValue,
      buffer,
    ...
    writtenBytes += BF.writeOptional(
      ...
      value.mixCustomType,
      (item, auxBuffer) =>
        BF.writeArray(true)(item, buffer, (item, auxBuffer) =>
